...
SYSTEM_PROMPT = (
    ...
    "Confessions section.\n\n"
    "CANCELLATIONS: if the newsletter says a Mass is NOT happening on a given day "
    "(e.g. 'No Mass on Wednesday'), DO emit a service entry for it with `time` set to "
    "null and `notes` set to the cancellation text (e.g. 'No Mass today'). The frontend "
    "renders these distinctly so people know not to drive there.\n\n"
